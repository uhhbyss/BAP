...
export function sendCheckIn(input, hardwareSetName, user, projName){
    return axios.post(PROJECTS_API_URL, null, {params: {typeReq: "checkIn", amount: input, hwset: hardwareSetName, username: user, project: projName}})
}

export function sendCheckOut(input, hardwareSetName, user, projName){
    return axios.post(PROJECTS_API_URL, null, {params: {typeReq: "checkOut", amount: input, hwset: hardwareSetName, username: user, project: projName}})
}
